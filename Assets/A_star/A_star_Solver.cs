...
public static class A_star_Solver
{
    ...
    /*public static int CalculateHeuristic(string state)
    {
        ...
        // Distanta Manhattan pentru fiecare piesa
        for (int i = 0; i < 54; i++)
        {
            if (state[i] != state[(i / 9) * 9]) // Daca piesa nu este în pozitia sa corecta
            {
                int targetPos = Array.IndexOf(state.ToCharArray(), state[i]);
    ...
    private static readonly Dictionary<int, Vector3> correctPositions = new Dictionary<int, Vector3>
    {
        ...
        { 3, new Vector3(0, 1, 1) }, { 4, new Vector3(1, 1, 1) }, { 5, new Vector3(2, 1, 1) },
        { 6, new Vector3(0, 1, 2) }, { 7, new Vector3(1, 1, 2) }, { 8, new Vector3(2, 1, 2) },

        // Front face (green)
        { 9, new Vector3(0, 0, 2) }, { 10, new Vector3(1, 0, 2) }, { 11, new Vector3(2, 0, 2) },
        { 12, new Vector3(0, 1, 2) }, { 13, new Vector3(1, 1, 2) }, { 14, new Vector3(2, 1, 2) },
        { 15, new Vector3(0, 2, 2) }, { 16, new Vector3(1, 2, 2) }, { 17, new Vector3(2, 2, 2) },

        // Right face (red)
        { 18, new Vector3(2, 0, 0) }, { 19, new Vector3(2, 0, 1) }, { 20, new Vector3(2, 0, 2) },
        { 21, new Vector3(2, 1, 0) }, { 22, new Vector3(2, 1, 1) }, { 23, new Vector3(2, 1, 2) },
        { 24, new Vector3(2, 2, 0) }, { 25, new Vector3(2, 2, 1) }, { 26, new Vector3(2, 2, 2) },

        // Back face (blue)
        { 27, new Vector3(0, 0, 0) }, { 28, new Vector3(1, 0, 0) }, { 29, new Vector3(2, 0, 0) },
        { 30, new Vector3(0, 1, 0) }, { 31, new Vector3(1, 1, 0) }, { 32, new Vector3(2, 1, 0) },
        { 33, new Vector3(0, 2, 0) }, { 34, new Vector3(1, 2, 0) }, { 35, new Vector3(2, 2, 0) },

        // Left face (orange)
        { 36, new Vector3(0, 0, 0) }, { 37, new Vector3(0, 0, 1) }, { 38, new Vector3(0, 0, 2) },
        { 39, new Vector3(0, 1, 0) }, { 40, new Vector3(0, 1, 1) }, { 41, new Vector3(0, 1, 2) },
        { 42, new Vector3(0, 2, 0) }, { 43, new Vector3(0, 2, 1) }, { 44, new Vector3(0, 2, 2) },

        // Down face (yellow)
        { 45, new Vector3(0, 0, 0) }, { 46, new Vector3(1, 0, 0) }, { 47, new Vector3(2, 0, 0) },
        { 48, new Vector3(0, 0, 1) }, { 49, new Vector3(1, 0, 1) }, { 50, new Vector3(2, 0, 1) },
        { 51, new Vector3(0, 0, 2) }, { 52, new Vector3(1, 0, 2) }, { 53, new Vector3(2, 0, 2) }
    };
    ...
    public static int CalculateHeuristic(string state)
    {
        ...
        // Calculate Manhattan distance for each piece
        for (int i = 0; i < 54; i++)
        {
            if (state[i] != state[(i / 9) * 9]) // If the piece is not in its correct position
            {
                Vector3 currentPos = correctPositions[i];
                Vector3 targetPos = correctPositions[state.IndexOf(state[i])];
                heuristic += (int)(Math.Abs(currentPos.x - targetPos.x) + Math.Abs(currentPos.y - targetPos.y) + Math.Abs(currentPos.z - targetPos.z));
            }
        }
 ...
 */
    ...
    {
        // Începe m?surarea timpului
        Stopwatch stopwatch = new Stopwatch();
        stopwatch.Start();

        // Începe m?surarea memoriei
        ...
        int maxIterations = 5000; // Ajusteaz? acest num?r în func?ie de necesitate
        ...
        while (openSet.Count > 0)
        {
            ...
            {
                // Opre?te m?surarea timpului
                stopwatch.Stop();

                // Opre?te m?surarea memoriei
        ...
        return null; // Nu s-a g?sit nicio solu?ie
    }
